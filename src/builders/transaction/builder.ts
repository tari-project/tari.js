...
export interface Builder {
  ...
  // createAccount<T extends TariCreateAccountDefinition>(
  //   func: T,
  //   args: Exclude<T["workspaceBucket"], undefined>,
  // ): TransactionBuilder;
  build(): Transaction;
}
...
export class TransactionBuilder implements Builder {
  ...
  // TODO
  // public createAccount<T extends TariCreateAccountDefinition>(
  //   method: T,
  //   args: Exclude<T["workspaceBucket"], undefined>,
  // ): TransactionBuilder {
  //   return this.addInstruction({
  //     type: "CreateAccount",
  //     ownerPublicKey: method.ownerPublicKey,
  //     workspaceBucket: method.workspaceBucket,
  //   });
  // }
