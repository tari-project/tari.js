...
import { FetchRpcTransport, RpcTransport } from ".";

interface SubstatesGetRequest {
  substate_id: string;
}

export * as transports from ".";
...
export class TUWalletDaemonClient {
  ...
  public static new(transport: RpcTransport): TUWalletDaemonClient {
    return new TUWalletDaemonClient(transport);
  }

  public static usingFetchTransport(url: string): TUWalletDaemonClient {
    return TUWalletDaemonClient.new(FetchRpcTransport.new(url));
  }
  ...
  public accountsGetBalances(params: AccountsGetBalancesRequest): Promise<AccountsGetBalancesResponse> {
    console.warn("📡 [WD][accountsGetBalances] params", typeof params.account, params);
  ...
  public substatesGet(params: SubstatesGetRequest): Promise<SubstatesGetResponse> {
    console.warn("📡 [WD][substatesGet] params", typeof params.substate_id, params);
  ...
  public nftsList(params: ListAccountNftRequest): Promise<ListAccountNftResponse> {
    console.warn("📡 [WD][nftsList] params", params);
  ...
  async __invokeRpc(method: string, params: object | null = null) {
    ...
    console.warn("📡 [WD][invokeRpc] request", req);
    ...
    console.warn("📡📡 [WD][invokeRpc] response", method, response);
