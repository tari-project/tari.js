...
const SIGNALING_SERVER_URL = import.meta.env.TARIJS_SIGNALING_SERVER_ADDRESS || "http://localhost:9100";
const SNAP_ID = import.meta.env.TARIJS_SNAP_ORIGIN || "local:http://localhost:8000";
